class level2 extends Phaser.Scene {
  ...
  {
    // Load das Imagens
    this.load.image('bgl2', 'assets/level2/bg_level2.png');
    this.load.image('plat', 'assets/level2/platform.png');
    this.load.image('plat1', 'assets/level2/platform1.png');
  ...
  create() 
  {
    ...
    this.platforms.create(760, 568, 'plat1').setScale(2).refreshBody();
    this.platforms.create(195, 568, 'plat').setScale(2).refreshBody();
    ...
    // Colisão das estrelas com as plataformas
    this.physics.add.collider(this.coins, this.platforms);

    // Texto para a pontuação e para o Nivel
    this.scoreText = this.add.text(10, 20, '', {fontSize: 'bold 32px', fill: '#000'});
    this.levelText = this.add.text(310, 20, 'LEVEL 2', { font: 'bold 30px Arial', fill: '#000'});
